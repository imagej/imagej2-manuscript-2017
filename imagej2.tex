...
\section*{Figures and illustrations}
  ...
  \begin{figure}[h!]
    ...
    \begin{flushleft}
      ...
      Intel Core i7 processor and 16 GB 1600 MHz DDR3 memory. The routines
      which produced these results can be found in the ImageJ Ops test code, in
      the \texttt{AddOpBenchmarkTest} class of the
