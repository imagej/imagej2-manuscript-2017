...
best from each world to accomplish their image analysis tasks. Parameterized
ImageJ commands and scripts may also continue to use ImageJ 1.x data structures
and plugins as needed, while taking advantage of ImageJ2 functionality as
appropriate (Figure 7), and declaring and populating input values with less
...
functionality alone is a years-long process as the ImageJ2 \acrshortpl{api}
...
the new \acrshortpl{api}. Meanwhile, development of ImageJ 1.x also
...
%% HACK: Without this, some tables end up floating in subsequent sections.
\FloatBarrier
